...
import '../../../driver/presentation/pages/home_page.dart';
      ...
      body: BlocListener<AuthBloc, AuthState>(
        listener: (context, state) {
          if (state is AuthError) {
            ...
            // Navegar al Home del conductor con el token
    ...
    return Positioned.fill(
      child: Image.asset(
        ...
        errorBuilder: (context, error, stackTrace) {
          // Si no hay imagen, usar gradiente oscuro
          return Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
    ...
    return Column(
      children: [
        ...
        ClipRRect(
          ...
          child: Image.asset(
            'assets/images/bdlogowhite.webp',
            width: 120,
            height: 120,
            fit: BoxFit.contain,
            errorBuilder: (context, error, stackTrace) {
